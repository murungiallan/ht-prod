                      ...
                      <div className="p-6">
                        ...
                        <ul className="space-y-5">
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Medication Adherence</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'medication-adherence-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                              ...
                              <button
                                onClick={() => downloadChartDataAsCSV(
                                  adherenceData,
                                  adherenceData.map(entry => 'date'),
                                  'medication-adherence-data',
                                  'label',
                                  'takenDoses'
                                )}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Food Calorie Intake</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'food-intake-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          ...
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Macronutrients</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'macros-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          ...
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Calories Burned - Exercise</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'calories-burned-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          ...
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Duration - Exercise</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'duration-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          ...
                          <li className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div className="text-sm font-semibold text-gray-800 mb-3">Sessions - Exercise</div>
                            <div className="flex gap-3">
                              <button
                                onClick={() => downloadChartImage(null, 'sessions-chart')}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                              >
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <button
                          ...
                          className="w-full mt-6 px-4 py-3 text-sm font-medium text-gray-800 bg-gray-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-start gap-2"
                        >
