...
const Contact = () => {
  ...
  return (
    <div className="bg-gray-50 pt-16 min-h-screen">
      {/* Hero Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-black via-gray-800 to-gray-900 text-white text-center relative overflow-hidden">
            ...
            >
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a href="https://facebook.com/swinburnesarawak" className="bg-indigo-100 p-2 rounded-full text-indigo-600 hover:bg-indigo-200 transition duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com/swinburnesarawak" className="bg-indigo-100 p-2 rounded-full text-indigo-600 hover:bg-indigo-200 transition duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <a href="https://linkedin.com/school/swinburne-sarawak" className="bg-indigo-100 p-2 rounded-full text-indigo-600 hover:bg-indigo-200 transition duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
