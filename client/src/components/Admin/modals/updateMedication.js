...
const UpdateMedicationModal = ({ data, onSubmit, onClose }) => {
  return (
    <motion.div
      ...
      >
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <input
            ...
            defaultValue={data.medication_name}
            className="w-full p-3 border border-gray-200 bg-gray-50 rounded-md focus:ring-2 focus:ring-indigo-500"
            required
          />
          <input
          ...
          <input
            ...
            defaultValue={data.times_per_day}
            className="w-full p-3 border border-gray-200 bg-gray-50 rounded-md focus:ring-2 focus:ring-indigo-500"
            required
          />
          <input
          ...
          <input
            ...
            defaultValue={data.start_date?.split("T")[0]}
            className="w-full p-3 border border-gray-200 bg-gray-50 rounded-md focus:ring-2 focus:ring-indigo-500"
          />
          <input
            type="date"
