    ...
    if (!meds || meds.length === 0) {
      return (
        <section className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-3 flex items-center gap-2 font-inter">
            {icon}
            {title}
          </h2>
            ...
            return (
              ...
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 w-full">
                  <div className="font-medium text-sm text-gray-800 font-inter">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-500 font-inter mr-2">
