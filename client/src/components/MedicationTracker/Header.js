    ...
    <header className="flex flex-col md:items-start gap-4 mb-4 w-full">
      ...
      <div className="bg-transparent px-4 py-3 focus-within:border-blue-500 overflow-hidden w-full">
        <input
          ...
          className="px-3 py-2 text-sm rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent w-full bg-transparent"
